 ...
 *
 * Usage: Committed as Next.js root middleware; matcher limits scope to dashboard routes.
 *
 * Security/PHI: Unauthenticated users are redirected to the configured sign-in page; no PHI in middleware.
 * HIPAA: N/A.
 * FHIR: N/A.
 * Accessibility: N/A.
